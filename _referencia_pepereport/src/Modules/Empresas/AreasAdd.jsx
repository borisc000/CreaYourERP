...
import { areas_redux, open_back } from '../../Redux/ComDuks';
...
import { guardarArea } from '../../Services/Empresas';
import { LoadAreas } from '../../Services/CommonService';
...
export default function AreasAdd() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispath(open_back(true, 'Registrando area'))
            guardarArea(values).then(() => {
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid size={{ xs: 12, md: 12, lg: 12 }} sx={{ p: mar, textAlign: 'left' }}>
                            <FormControl component='fieldset' style={{ minWidth: '100%' }}>
                                <FormLabel sx={{}}>Area de servicio</FormLabel>
                                <TextField
                                    id='area'
                                    name='area'
                                    size='small'
                                    ...
                                    fullWidth
                                    required
                                    sx={{ mr: 1, backgroundColor: 'rgba(255,255,255,0.7)', textAlign: 'left' }}
