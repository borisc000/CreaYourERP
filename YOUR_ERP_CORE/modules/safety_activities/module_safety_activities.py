...
DEFAULT_ACTIVITY_BLOCKS.extend(
    [
        ...
        _bot_seed("BOT-VEH-CHECKLIST", "Checklist preuso de vehiculo", process="Vehiculos", task="Verificar vehiculo antes del uso", block_type="critical", criticality="high", tags=["vehiculo", "preuso", "conduccion"], risk_code="D1", hazard="Vehiculo con falla critica o documentacion no vigente", ppe=["Chaleco reflectante", "Calzado de seguridad"]),
        _bot_seed("BOT-VEH-MANIOBRA", "Maniobra y estacionamiento seguro", process="Vehiculos", task="Ingresar, maniobrar y estacionar en faena", block_type="critical", criticality="high", tags=["vehiculo", "maniobra", "peatones"], risk_code="D1", hazard="Atropello, colision o atrapamiento durante maniobra", ppe=["Chaleco reflectante", "Casco"]),
        _bot_seed("BOT-HERR-CONTROL", "Control de herramientas defectuosas", process="Herramientas", task="Retirar y registrar herramientas fuera de estandar", block_type="generic", criticality="medium", tags=["herramientas", "control", "preuso"], risk_code="F1", hazard="Uso de herramienta defectuosa o intervenida", ppe=["Lentes de seguridad", "Guantes"]),
    ]
)
